...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            # sparse_conv_ext (spconv) is intentionally excluded: its vendored
            # C++ uses torch::nn init APIs incompatible with newer libtorch
            # (torch::kFanIn enum vs int) and MapTR does not use spconv.
            make_cuda_ext(
                name='iou3d_cuda',
